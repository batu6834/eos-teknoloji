...
function Shell() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* --- YENİ EKLENEN KISIM --- */}
      {/* Navbar'ın 72px'lik (pt-18) yüksekliği için global boşluk eklendi. */}
      {/* Admin sayfalarında Navbar olmadığı için, bu boşluğu uygulamıyoruz. */}
      <main className={!isAdminPage ? "pt-18" : ""}>
        <Routes>
          {/* Website tarafı */}
...
// Bu kısma zaten hiç dokunmamıştık, orijinal haliyle duruyor.
