...
import servicesData from '../data/servicesData/TechnicServiceData';
...
function TechnicalService() {
    ...
    // printer-video.mp4 için YouTube ID'si: lOWhcX7JVy4
    const videoSrc = "https://www.youtube.com/embed/lOWhcX7JVy4?autoplay=1&mute=1&loop=1&playlist=lOWhcX7JVy4&controls=0&showinfo=0&modestbranding=1&autohide=1";
    ...
    return (
        <div>
            ...
            <div className="relative h-[50vh] md:h-[70vh] overflow-hidden">
                ...
                {/* Video üzerine metin (bu kısım aynı kaldı) */}
