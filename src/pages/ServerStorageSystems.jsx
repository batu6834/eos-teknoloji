...
import servicesData from '../data/servicesData/ServerStorageSystemsData';

function ServerStorageSystems() {
    useEffect(()=>{
        window.scrollTo(0, 0);
    }, []);
    ...
    return (
        <div>
            {/* Hero Section with Video Background - Hafif gölgeli */}
            <div className="relative h-[50vh] md:h-[70vh] overflow-hidden">
                <video
                    // Buraya sunucu ve depolama hizmetinize ait bir video yolu ekleyin
                    src="/videos/server-storage-systems-video.mp4"
                    autoPlay
                    loop
                    muted
                    playsInline
                ...
                {/* Video üzerine yarı saydam koyu katman (çok az opaklık) ve metin */}
                <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-center items-center text-white text-center p-4 z-10">
            ...
            <div className="max-w-5xl mx-auto px-4 py-10 bg-white shadow-lg rounded-lg -mt-16 relative z-20">
                ...
                <div className="mt-10 text-center">
                    <p className="text-gray-600 text-lg mb-4">Sunucu ve depolama çözümlerimiz hakkında daha fazla bilgi almak için:</p>
                    <Link
                        to="/contact"
...
export default ServerStorageSystems;
