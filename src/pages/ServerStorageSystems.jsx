...
function ServerStorageSystems() {
    ...
    // server-storage-systems-video.mp4 için YouTube ID'si: ZmGbRCrvJWg
    const videoSrc = "https://www.youtube.com/embed/ZmGbRCrvJWg?autoplay=1&mute=1&loop=1&playlist=ZmGbRCrvJWg&controls=0&showinfo=0&modestbranding=1&autohide=1";
