...
import servicesData from '../data/servicesData/OperationalEquipmentRentalData';

function OperationalEquipmentRental() {
    useEffect(()=>{
        window.scrollTo(0, 0);
    }, []);
    ...
    return (
        <div>
            ...
            <div className="relative h-[50vh] md:h-[70vh] overflow-hidden">
                <video
                    // Operasyonel cihaz kiralamaya uygun bir video yolu
                    src="/videos/operational-equipment-video.mp4"
                    autoPlay
                    loop
                    muted
                    playsInline
            ...
            <div className="max-w-5xl mx-auto px-4 py-10 bg-white shadow-lg rounded-lg -mt-16 relative z-20">
                ...
                <div className="mt-10 text-center">
                    <p className="text-gray-600 text-lg mb-4">Cihaz kiralama çözümlerimiz hakkında daha fazla bilgi almak için:</p>
                    <Link
                        to="/contact"
...
export default OperationalEquipmentRental;
