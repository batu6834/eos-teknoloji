...
import servicesData from '../data/servicesData/SmartNetworkTechnologiesData'; // Veriler artık bu dosyadan alınıyor

function SmartNetworkTechnologies() {
    useEffect(()=>{
        window.scrollTo(0, 0);
    }, []);
    ...
    return (
        <div>
            ...
            <div className="relative h-[50vh] md:h-[70vh] overflow-hidden">
                <video
                    // Akıllı ağ teknolojilerine uygun bir video yolu
                    src="/videos/smart-network-video.mp4"
                    autoPlay
                    loop
                    muted
                    playsInline
            ...
            {/* Ana İçerik Bölümü - Hero alanının üzerine bindirilmiş */}
            <div className="max-w-5xl mx-auto px-4 py-10 bg-white shadow-lg rounded-lg -mt-16 relative z-20">
                ...
                <div className="mt-10 text-center">
                    <p className="text-gray-600 text-lg mb-4">Akıllı ağ çözümlerimiz hakkında daha fazla bilgi almak için:</p>
                    <Link
                        to="/contact"
...
export default SmartNetworkTechnologies;
