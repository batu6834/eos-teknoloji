...
import servicesData from '../data/servicesData/SmartNetworkTechnologiesData';
...
function SmartNetworkTechnologies() {
    ...
    // smart-network-video.mp4 için YouTube ID'si: KKAM1NbRKPk
    const videoSrc = "https://www.youtube.com/embed/KKAM1NbRKPk?autoplay=1&mute=1&loop=1&playlist=KKAM1NbRKPk&controls=0&showinfo=0&modestbranding=1&autohide=1";
